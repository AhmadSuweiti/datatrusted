"""
AuditReport — the central result object returned by :func:`datatrusted.audit`.
...
from datatrusted.utils import pct_str
...
@dataclass
class AuditReport:
    """Structured result returned by :func:`datatrusted.audit`.
    ...
    def to_markdown(self, path: Optional[str] = None) -> str:
        ...
        lines += [
            "---",
            "*Generated by [datatrusted](https://github.com/yourusername/datatrusted)*",
        ]
...
def _render_html(report: AuditReport) -> str:
    ...
    parts: List[str] = [
        ...
        "<title>datatrusted Audit Report</title>",
        _HTML_STYLES,
        "</head><body>",
        "<h1>datatrusted Audit Report</h1>",
    ...
    parts.append(
        "<p class='meta'>Generated by <strong>datatrusted</strong></p></body></html>"
    )
